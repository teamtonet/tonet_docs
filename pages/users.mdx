...
- Email of the user
- Extension ?
- Outbound number, you can [purchase a phone](https://docs.tonet.ai/phones/purchase_number) number and assign it to any user.
...
You will be automatically redirected to tonet.app, [where you can make calls and send SMS.](https://docs.tonet.ai/app)
