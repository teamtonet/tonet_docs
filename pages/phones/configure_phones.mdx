...
### Turn ON/OFF Call Recording
    ...
    Call Recordings can be viewed in the [Call Logs](https://tonet.io/dashboard/call_logs/)
### Change Default Phone Destination
    ...
    * Auto Attendant: Send the call to an [Auto Attendant](https://tonet.io/dashboard/ivrs) 
...
**You should be able to see where your phone is routing to currently in the [Phones tab](https://tonet.io/dashboard/phones) , under the Current Path Header**
